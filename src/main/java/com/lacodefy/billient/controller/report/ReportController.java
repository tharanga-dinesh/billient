package com.lacodefy.billient.controller.report;
...
@Controller
@RequestMapping(ReportController.REQUEST_MAPPING_URL)
public class ReportController {

	public static final String REQUEST_MAPPING_URL = "/report";
	...
	public ModelAndView index(final Model model, @ModelAttribute("success") final String success, @ModelAttribute("error") final String error) {
		final ModelAndView modelAndView = new ModelAndView(ReportController.RESOURSE_MAP_PATH + "home-view");
