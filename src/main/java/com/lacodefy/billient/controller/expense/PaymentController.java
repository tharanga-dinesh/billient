...
public class PaymentController {
	...
	private static final String RESOURSE_MAP_PATH = "expense/payment/";
	...
	public ModelAndView index(final Model model, @ModelAttribute("success") final String success, @ModelAttribute("error") final String error) {
		final ModelAndView modelAndView = new ModelAndView(PaymentController.RESOURSE_MAP_PATH + "home-view");
