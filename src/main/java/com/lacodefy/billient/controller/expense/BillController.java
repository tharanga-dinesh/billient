...
@Controller
@RequestMapping(BillController.REQUEST_MAPPING_URL)
public class BillController {

	public static final String REQUEST_MAPPING_URL = "/expense";
	private static final String RESOURSE_MAP_PATH = "expense/bill/";
	...
	public ModelAndView index(final Model model, @ModelAttribute("success") final String success, @ModelAttribute("error") final String error) {
		final ModelAndView modelAndView = new ModelAndView(BillController.RESOURSE_MAP_PATH + "home-view");
