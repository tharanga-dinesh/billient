...
@Controller
@RequestMapping(CusotmerController.REQUEST_MAPPING_URL)
public class CusotmerController {

	public static final String REQUEST_MAPPING_URL = "/customer";
	private static final String RESOURSE_MAP_PATH = "income/customer/";
	...
	public ModelAndView index(final Model model, @ModelAttribute("success") final String success, @ModelAttribute("error") final String error) {
		final ModelAndView modelAndView = new ModelAndView(CusotmerController.RESOURSE_MAP_PATH + "home-view");
