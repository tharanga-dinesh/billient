package com.lacodefy.billient.controller.banking;
...
@Controller
@RequestMapping(BankingController.REQUEST_MAPPING_URL)
public class BankingController {

	public static final String REQUEST_MAPPING_URL = "/banking";
	...
	public ModelAndView index(final Model model, @ModelAttribute("success") final String success, @ModelAttribute("error") final String error) {
		final ModelAndView modelAndView = new ModelAndView(BankingController.RESOURSE_MAP_PATH + "home-view");
